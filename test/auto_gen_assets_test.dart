...
void main() {
  group('AssetGenerator', () {
    ...
    test('should generate assets file when assets directory exists', () {
      ...
      expect(
        content,
        contains("final String background = 'assets/images/background.jpg'"),
      );
      expect(
        content,
        contains("final String roboto = 'assets/fonts/roboto.ttf'"),
      );
    });
    ...
    test('should include hidden files when ignoreHiddenFiles is false', () {
      ...
      expect(
        content,
        contains("final String hidden = 'assets/images/.hidden.png'"),
      );
    });
    ...
    test('should ignore env files when ignoreEnvFiles is true', () {
      ...
      expect(
        content,
        contains("final String normal = 'assets/config/normal.json'"),
      );
    ...
    test('should convert file names to camelCase correctly', () {
      ...
      expect(
        content,
        contains("final String myFileName = 'assets/images/my_file_name.png'"),
      );
      expect(
        content,
        contains("final String userAvatar = 'assets/images/user-avatar.jpg'"),
      );
      expect(content, contains("final String logo = 'assets/images/logo.png'"));
    });
    ...
    test('should convert folder names to PascalCase correctly', () {
      ...
      expect(
        content,
        contains('static const UserAvatars userAvatars = UserAvatars();'),
      );
    ...
    test('should skip files not in subfolders', () {
      ...
      File(
        '${assetsDir.path}/images/logo.png',
      ).createSync(); // Should be included
